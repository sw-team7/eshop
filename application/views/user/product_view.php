				...
				<div id="product-main-img">
					...
					for ($i = 0; $i < 4; $i++) {
						...
						<div class="product-preview">
							<img src="<?php echo base_url('assets/' . $product->image); ?>"
						...
						<div id="tab1" class="tab-pane fade in active">
							<div class="row">
								<div class="col-md-12">
                                    ...
                                    <p>Here the description of the product will be showed</p><br>
						...
						<div id="tab2" class="tab-pane fade in">
							<div class="row">
								<div class="col-md-12">
                                    ...
                                    <h5> Category name: <?= $product->cat_name; ?></h5>
                                    <h5> Product Price: <?= $product->price; ?> BDT</h5>
...
<div class="section">
	...
	<div class="container">
		...
		<div class="row">
			...
			<?php
			foreach ($retated_product as $row) {
				?>
				<!-- product -->
				<div class="col-md-3 col-xs-6">
					<div class="product">
						...
						<div class="product-body">
							...
							<h4 class="product-price"><?= $row->price ?>
								<del class="product-old-price"><?= $row->price ?></h4>
							<div class="product-rating">
							</div>
