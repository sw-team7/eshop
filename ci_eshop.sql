...
(2, 'Shafayet Rahman', 'shad', 'shad'),
(3, 'Kazal Ghosh', 'kazal', 'kazal'),
(4, 'Mohaimin Morsalin', 'morsalin', 'morsalin');
...
INSERT INTO `tbl_cart` (`cart_id`, `sId`, `product_id`, `price`, `quantity`) VALUES
(69, 'orcg6446shfg84ldppu27rnft34pa5gv', 12, '80000.00', 1),
(70, '2o4j69uhjajoactmdi1cviqg775c41ll', 14, '50000.00', 1),
(71, '2o4j69uhjajoactmdi1cviqg775c41ll', 13, '70000.00', 1),
(72, '2o4j69uhjajoactmdi1cviqg775c41ll', 12, '80000.00', 1);
...
(1, 'Mobile Phones', 'image/catImg/Cat-mobile.jpg', 'This is mobile Category', 1),
...
(3, 'Shafayet', 'Rahman', 'Adabor,Mohammadpur', 'Dhaka', 1200, '01760281507', 'abc@gmail.com', 18, '12345');
...
INSERT INTO `tbl_orders` (`order_id`, `order_code`, `customer_id`, `session_id`, `order_date`, `shipment_date`) VALUES
(42, NULL, 1, 'r9mr8nosnal2dkkltminfbcfbp', '2017-12-30 02:30:15', NULL);
...
INSERT INTO `tbl_order_details` (`order_details_id`, `order_id`, `product_id`, `product_quantity`, `order_price`, `status`) VALUES
(20, 42, 12, 1, '80000.00', 1),
(21, 42, 14, 1, '50000.00', 0);
...
(6, 'Asus Zenphone 4', 1, 8, '<p>Asus zenphone 4 with very high configuration</p>', '10000.000', 0, 'uploads/e82562b82e.jpg'),
(7, 'Asus Zenphone 5', 1, 8, '<p>Asus zenphone 5 with very high resulation camera..</p>', '15000.000', 0, 'uploads/0f3d45559a.jpg'),
(8, 'Rolex Watch', 5, 9, '<p>Rolex is one of the most expensive wathches in the world..</p>', '90000.000', 0, 'uploads/be0d4c880e.jpg'),
(9, 'Rolex Watch For Men', 5, 9, '<p>These watches are for men only..</p>', '100000.000', 1, 'uploads/fee6305480.jpg'),
(10, 'Hp Paviloin Core I7', 6, 10, '<p>Hp Paviloin Core I7 with high configuration</p>', '60000.000', 1, 'uploads/673bf65d9d.jpg'),
(11, 'Dell Core I7', 6, 11, '<p>Dell Core I7 with very High Configuration</p>', '55000.000', 1, 'uploads/75c0c31db5.jpg'),
(12, 'IPhone 7 Plus', 1, 5, '<p>Iphone 7 plus is available with discount</p>', '80000.000', 0, 'uploads/557630b484.jpg'),
(13, 'Samsung 56 Inch Led Tv', 4, 3, '<p>Samsung Led tv with HD configuration</p>', '70000.000', 1, 'uploads/7eb15aabb4.jpg'),
(14, 'Desktop Core I7', 2, 3, '<p>Desktop With 2 TB hard Disk and 16 GB Ram..</p>', '50000.000', 0, 'uploads/dbfefbcd73.jpg');
...
INSERT INTO `tbl_rating` (`rating_id`, `product_id`, `user_id`, `rating`) VALUES
(1, 13, 1, 4),
(2, 13, 3, 5);
...
--
-- Table structure for table `tbl_users_demo`
--

CREATE TABLE `tbl_users_demo` (
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_users_demo`
--

INSERT INTO `tbl_users_demo` (`user_id`, `ip_address`, `sId`) VALUES
(9, '45.250.229.156', 'i157nqiahb8hh7jornpfpj92v6f2ju5c'),
(10, '103.96.69.74', '5pgt3p9jbh90ufmn8kbbftl79fn66cdp'),
(11, '103.96.69.74', '2o4j69uhjajoactmdi1cviqg775c41ll'),
(12, '::1', '6jre9bs5ohhflu41p6ojq2lvqt4ttg38'),
(13, '::1', 'tcsg3c9r8j2sj6vkqr1ec4liq58q9r77'),
(14, '::1', 'o6jd05ejg988oqk49ksao2kppsvsidgr');
...
--
-- Indexes for table `tbl_users_demo`
--
ALTER TABLE `tbl_users_demo`
...
--
-- AUTO_INCREMENT for table `tbl_users_demo`
--
ALTER TABLE `tbl_users_demo`
...
ALTER TABLE `tbl_order_details`
  ...
  ADD CONSTRAINT `tbl_order_details_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `tbl_orders` (`order_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `tbl_rating`
  ...
  ADD CONSTRAINT `tbl_rating_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `tbl_customers` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE;
